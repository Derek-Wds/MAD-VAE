...
if __name__ == "__main__":
    ...
    for adv in adv_accuracy:
        ...
        plt.xticks([])
        plt.yticks([])
        plt.title(f'MNIST clustering under {adv.upper()} with {exp_name[args.experiment]}', fontsize=24);
        plt.savefig(f'img/{adv}_{experiments[args.experiment]}.png', dpi=300, pad_inches=0)
        plt.clf()
