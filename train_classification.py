...
def main():
    ...
    for epoch in range(1, args.epochs+1):
        ...
        if epoch % 5 == 0:
            torch.save(model.cpu().state_dict(), '{}/classification/params_{}.pt'.format(args.model_dir, epoch))
        
    torch.save(model.cpu().state_dict(), '{}/classification/params.pt'.format(args.model_dir))
